...
public class TestMove : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
{
    private bool isDown;
    Vector3 originsInput;
    Vector3 offset;
    float dis = 0;
    float originsY = 0;
    ...
    private void Awake()
    {
        originsY = transform.GetComponent<RectTransform>().localPosition.y;
    }
    public void OnPointerDown(PointerEventData eventData)
    {
        originsInput = Input.mousePosition;
        isDown = true;
    }
    ...
    private void Update()
    {
        if (isDown)
        {
            ...
            dis = (pos.y - originsInput.y);
            originsInput = pos;
            gameObject.transform.GetComponent<RectTransform>().localPosition += new Vector3(0, dis, 0);
        }
    }
